...
/**
 * Main table for the ShippingEasy app: stores APL data, per-channel config,
 * rate cache entries, idempotency keys, and the channel<->config mapping.
 */
...
const tableName = env.DYNAMODB_MAIN_TABLE_NAME ?? "shippingeasy-app-main";
