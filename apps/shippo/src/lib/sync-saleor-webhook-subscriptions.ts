...
import { shippingListMethodsForCheckoutWebhookDefinition } from "@/app/api/webhooks/saleor/shipping-list-methods-for-checkout/webhook-definition";
...
const WEBHOOK_SYNCS: ReadonlyArray<{
  ...
  {
    name: "Shippo list methods for checkout",
    getManifest: (baseUrl) =>
      shippingListMethodsForCheckoutWebhookDefinition.getWebhookManifest(baseUrl) as WebhookManifestLite,
  },
  {
    name: "Shippo order created",
    getManifest: (baseUrl) =>
